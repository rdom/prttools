...
void datainfo_init(){
  ...
  //   {
  //     // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum
  //     dataArray.push_back(DataInfo(200,"sim_00",2,0,20.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_01",2,0,25.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_02",2,0,30.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_03",2,0,35.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_04",2,0,40.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_05",2,0,45.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_06",2,0,50.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_07",2,0,55.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_08",2,0,60.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_09",2,0,65.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_10",2,0,70.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_11",2,0,75.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_12",2,0,80.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_13",2,0,85.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_14",2,0,90.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_15",2,0,95.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_16",2,0,100.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_17",2,0,105.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_18",2,0,110.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_19",2,0,115.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_20",2,0,120.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_21",2,0,125.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_22",2,0,130.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_23",2,0,135.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_24",2,0,140.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_25",2,0,145.0,364,85.0,0.00,0,7.0));
  //     dataArray.push_back(DataInfo(200,"sim_26",2,0,150.0,364,85.0,0.00,0,7.0));
  //   }
  ...
  //     dataArray.push_back(DataInfo(203,Form("sim_%d",a),2,2,a,364,85.0,0.00,0,7.0,10));
  //   }
  ...
  //   study[205]="sim Oct 16, plate, lens 2, beam dimension scan";
  ...
  // 	dataArray.push_back(DataInfo(209,files[i],2,0,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }
  //   }
  ...
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(210,files[i],2,0,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }
  ...
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(211,files[i],2,2,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }
  ...
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(212,files[i],2,0,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }      
  //   }
  ...
  //     for(Int_t i=0; i<5; i++){
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(213,files[i],2,0,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }      
  //   }
  ...
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(214,files[i],1,3,25.0,364,85.0,70,5,7.0,10,o));	
  //     }      
  //   }
  ...
  //     // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  //     dataArray.push_back(DataInfo(215,"beam_16301130321",1,3,20.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301135650",1,3,30.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301142633",1,3,35.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301150734",1,3,40.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301153804",1,3,45.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301161333",1,3,50.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301164958",1,3,55.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301173105",1,3,60.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301180149",1,3,65.0,364,85.0,70.00,5,7.0,10,o));
  //     dataArray.push_back(DataInfo(215,"beam_16301183115",1,3,70.0,364,85.0,70.00,5,7.0,10,o));
  //   }
  ...
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(216,files[i],1,0,25.0,364,85.0,70,5,7.0,10,o));	
  //     }
  //   }
  ...
  //     for(Int_t i=0; i<40; i++){
  // 	// study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset  
  // 	dataArray.push_back(DataInfo(217,files[i],2,0,25.0,364,85.0,0.00,0,7.0,10,o));	
  //     }
  //   }

  //   study[218]="mom-angle scan  , plate, cy lens, 1mV th. offset";
  //   {
  //     Double_t o = 12.59 +95.6;//-59; // 185.7

  //     // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset
      
  //     dataArray.push_back(DataInfo(218,"beam_2_90",2,2,90.0,364,85.0,0.00,0,2.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_2_90P",2,2,90.0,364,85.0,0.00,0,2.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_3_60",2,2,60.0,364,85.0,0.00,0,3.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_3_60P",2,2,60.0,364,85.0,0.00,0,3.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_3_25",2,2,25.0,364,85.0,0.00,0,3.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_3_25P",2,2,25.0,364,85.0,0.00,0,3.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_4_50",2,2,50.0,364,85.0,0.00,0,4.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_4_50P",2,2,50.0,364,85.0,0.00,0,4.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_5_25",2,2,25.0,364,85.0,0.00,0,5.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_5_25P",2,2,25.0,364,85.0,0.00,0,5.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_5_43",2,2,43.0,364,85.0,0.00,0,5.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_5_43P",2,2,43.0,364,85.0,0.00,0,5.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_6_36",2,2,36.0,364,85.0,0.00,0,6.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_6_36P",2,2,36.0,364,85.0,0.00,0,6.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_7_33",2,2,33.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_7_33P",2,2,33.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_8_25",2,2,25.0,364,85.0,0.00,0,8.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_8_25P",2,2,25.0,364,85.0,0.00,0,8.0,5,o));
  //     dataArray.push_back(DataInfo(218,"beam_8_33",2,2,33.0,364,85.0,0.00,0,8.0,5,o));
  //     //      dataArray.push_back(DataInfo(218,"beam_8_33P",2,2,33.0,364,85.0,0.00,0,8.0,5,o));
  //   }

  //   study[219]="mom-angle scan  , plate, cy lens, 1mV th. offset, 7m focus";
  //   {
  //     Double_t o = 12.59 + 95.6;
      
  //     // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset

  //     dataArray.push_back(DataInfo(219,"beam219_7_25",2,2,25.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_25P",2,2,25.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_30",2,2,30.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_30P",2,2,30.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_35",2,2,35.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_35P",2,2,35.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_45",2,2,45.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_45P",2,2,45.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_55",2,2,55.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_55P",2,2,55.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_125",2,2,125.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_125P",2,2,125.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_7_140",2,2,140.0,364,85.0,0.00,0,7.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_7_140P",2,2,140.0,364,85.0,0.00,0,7.0,5,o));
  //     dataArray.push_back(DataInfo(219,"beam219_8_30",2,2,30.0,364,85.0,0.00,0,8.0,5,o));
  //     //      dataArray.push_back(DataInfo(219,"beam219_8_30P",2,2,30.0,364,85.0,0.00,0,8.0,5,o));
  //   }
  ...
  //     dataArray.push_back(DataInfo(221,"beam_16305204455",2,0,140.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305204944",2,0,130.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305205404",2,0,120.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305205735",2,0,110.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305210108",2,0,100.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305210424",2,0, 90.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305210909",2,0, 80.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305211237",2,0, 70.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305211556",2,0, 60.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305211950",2,0, 50.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305212325",2,0, 40.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305212714",2,0, 30.0,364,85.0,0.00,0,7.0,10,o));
  //     dataArray.push_back(DataInfo(221,"beam_16305213705",2,0, 20.0,364,85.0,0.00,0,7.0,10,o));
  //   }

  //   study[222]="7GeV, 35  degree, plate, no lens, 1mV th. offset";
  //   {
  //     Double_t o = 12.59 +95.6;
  ...
  // Jul2018
  {
    ...
    {
      // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset | phi
      dataArray.push_back(DataInfo(415,"beam_415_10",1,3,20.0,424,85.0,70.00,16.45,10.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_9", 1,3,20.0,424,85.0,70.00,16.45, 9.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_8", 1,3,20.0,424,85.0,70.00,16.45, 8.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_7", 1,3,20.0,424,85.0,70.00,16.45, 7.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_6", 1,3,20.0,424,85.0,70.00,16.45, 6.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_5", 1,3,20.0,424,85.0,70.00,16.45, 5.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_4", 1,3,20.0,424,85.0,70.00,16.45, 4.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_3", 1,3,20.0,424,85.0,70.00,16.45, 3.0,10,o,0));
      dataArray.push_back(DataInfo(415,"beam_415_2", 1,3,20.0,424,85.0,70.00,16.45, 2.0,10,o,0));
    }
    ...
    {
      // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset | phi
      dataArray.push_back(DataInfo(420,"beam_421_wo",1,3,25.0,424,85.0,70.00,16.45,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_421_wi",1,3,25.0,424,85.0,70.00,16.45,7.0,10,o,0));
    }
    study[422]= "Theta scan at phi=0 deg @ 4 GeV/c. Bar, 3LS lens, grease everywere";
    {
      // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset | phi
      dataArray.push_back(DataInfo(420,"beam_422_20",1,3,20.0,424,85.0,70.00,16.45,4.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_422_25",1,3,25.0,424,85.0,70.00,16.45,4.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_422_30",1,3,30.0,424,85.0,70.00,16.45,4.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_422_60",1,3,60.0,424,85.0,70.00,16.45,4.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_422_90",1,3,90.0,424,85.0,70.00,16.45,4.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_422_140",1,3,140.0,424,85.0,70.00,16.45,4.0,10,o,0));
    }

    study[422]= "Fine theta scan at phi=0 deg @ 1.5 GeV/c. Bar, 3LS lens, grease everywere";
    {
      dataArray.push_back(DataInfo(422,"beam_18220132601",1,3,90.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220132829",1,3,91.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220133026",1,3,92.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220133224",1,3,93.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220133424",1,3,94.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220133641",1,3,95.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220133858",1,3,96.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220134101",1,3,97.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220134302",1,3,98.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220134524",1,3,99.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220134739",1,3,100.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220134940",1,3,101.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220135147",1,3,102.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220135359",1,3,103.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220135600",1,3,104.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220135800",1,3,105.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220140009",1,3,110.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220140437",1,3,115.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220140652",1,3,120.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220140859",1,3,130.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220141114",1,3,135.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220141430",1,3,140.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220141845",1,3,80.0,424,85.0,70.00,16.45,1.5,10,o,0));
      dataArray.push_back(DataInfo(422,"beam_18220142854",1,3,85.0,424,85.0,70.00,16.45,1.5,10,o,0));
    }

    
    study[423]= "Fine theta scan at phi=0 deg @ 1.5 GeV/c. Bar, 3LS lens, grease everywere";
    {
      dataArray.push_back(DataInfo(423,"beam_18220144642",1,3,20.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220145129",1,3,30.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220145842",1,3,40.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220150324",1,3,50.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220150922",1,3,60.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220151434",1,3,70.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220152011",1,3,75.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220152458",1,3,80.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220153017",1,3,81.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220153503",1,3,82.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220153941",1,3,83.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220154406",1,3,84.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220155023",1,3,85.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220155459",1,3,86.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220155943",1,3,87.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220160420",1,3,88.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220161102",1,3,89.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220161752",1,3,90.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220162300",1,3,92.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220163058",1,3,95.0,424,85.0,70.00,16.45,2.0,10,o,0));
      dataArray.push_back(DataInfo(423,"beam_18220163736",1,3,100.0,424,85.0,70.00,16.45,2.0,10,o,0));
    }

    study[424]= "Theta scan at phi=0 deg @ 8 GeV/c. Bar, 3LS lens, grease everywere";
    {
      dataArray.push_back(DataInfo(424,"beam_424_20",1,3,20.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_25",1,3,25.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_30",1,3,30.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_35",1,3,35.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_40",1,3,40.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_50",1,3,50.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_60",1,3,60.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_70",1,3,70.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_80",1,3,80.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_90",1,3,90.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_100",1,3,100.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_110",1,3,110.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_120",1,3,120.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_130",1,3,130.0,424,85.0,70.00,16.45,8.0,10,o,0));
      dataArray.push_back(DataInfo(424,"beam_424_140",1,3,140.0,424,85.0,70.00,16.45,8.0,10,o,0));
    }   
