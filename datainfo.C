...
void datainfo_init(){
  ...
  //= Jul 2018 =================================
  {
    ...
    {
      // study id | run name | radiator | lens | angle | z pos | x pos | x step | y step | momentum | beam dim | sim offset | phi
      dataArray.push_back(DataInfo(420,"beam_18219154515",1,3,90.0-0.25,250-15-7,85.0,65.00,18.5,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_18219142232",1,3,90.0-0.25,424-15-7,85.0,65.00,18.5,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_18219161250",1,3,90.0-0.25,550-15-7,85.0,65.00,18.5,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_18219163624",1,3,90.0-0.25,650-15-7,85.0,65.00,18.5,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_18219165621",1,3,90.0-0.25,750-15-7,85.0,65.00,18.5,7.0,10,o,0));
      dataArray.push_back(DataInfo(420,"beam_18219171427",1,3,90.0-0.25,850-15-7,85.0,65.00,18.5,7.0,10,o,0));
    }
