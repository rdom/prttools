...
void recoPdf(TString path="/data.local/data/jun15/beam_15177050804S.root"){
  ...
  TH1F *hllf= new TH1F("hllf","hllf;log likelihood; entries [#]",100,-100,100);
  TH1F *hlls= new TH1F("hlls","hlls;log likelihood; entries [#]",100,-100,100);
  
  TF1 *pdff[960],*pdfs[960];
  TH1F *hpdff[960],*hpdfs[960];
  //  TFile f(path+".pdf.root");
    TFile f("/data.local/data/jun15/scan_tr/hh1521_04.pdf.root");
